...
cthulhu.configure = function (config) {
  ...
  if (config["public"]) {
    cthulhu.use(express["static"](path.resolve(process.env.INIT_DIR, config["public"]), { maxAge: week } // TTL (Time To Live) for static files
    ));
  }
...
// Export mailer
var Mailer = exports.Mailer = mailer;
